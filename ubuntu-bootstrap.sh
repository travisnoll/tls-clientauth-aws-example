...
git clone https://github.com/travisnoll/tls-clientauth-aws-example.git ~ubuntu/tls-clientauth-aws-example
...
sudo a2enmod ssl
bash ~ubuntu/tls-clientauth-aws-example/server3.sh
